 ...
 */
final class Version20240416163804 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE player (id INT NOT NULL, firstname VARCHAR(255) NOT NULL, lastname VARCHAR(255) DEFAULT NULL, gender ENUM(\'man\', \'woman\'), skill ENUM(\'beginner\', \'middle\', \'high\'), PRIMARY KEY(id))');
