 ...
 */
final class Version20240419181940 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE encounter_player (id INT NOT NULL, encounter_id INT NOT NULL, player_id INT NOT NULL, is_team1 BOOLEAN NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('ALTER TABLE encounter_player ADD CONSTRAINT FK_9CFF9D6D99E6F5DF FOREIGN KEY (player_id) REFERENCES player (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE encounter_player DROP CONSTRAINT FK_9CFF9D6D99E6F5DF');
